                        ...
                        <View key={index} style={styles.row}> 
                            <View style={styles.labelContainer}>
                                ...
                                {item.info && (
                                    ...
                                    >
                                        <MaterialIcons name="info-outline" size={responsiveWidth(4)} color={Colors.primary || '#007AFF'} />
                                    </TouchableOpacity>
                                )}
                            </View>
                            <Text selectable={true} style={styles.value}>{item?.value?item?.value: 'NA'}</Text>
                        </View>
                    ))
                )}
            </View>
